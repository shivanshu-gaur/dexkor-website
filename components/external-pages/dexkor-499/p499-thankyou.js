...
(function(){const q=new URLSearchParams(location.search);const nm=(q.get("n")||"").trim();
 const el=document.getElementById("tyName");if(el&&nm){el.textContent=", "+nm.charAt(0).toUpperCase()+nm.slice(1);}})();
